...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 flex items-center justify-center py-8 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 font-medium">Welcome back to your journey</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="border-rose-200 focus:border-rose-400 font-medium pr-10"
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm text-rose-600 hover:text-rose-700 underline font-semibold"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-semibold py-3 text-lg shadow-lg"
              >
                Sign In
              </Button>
            </form>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 font-medium">
                ...
                <Link href="/auth/register" className="text-rose-600 hover:text-rose-700 underline font-semibold">
                  Create one here
                </Link>
              </p>
            </div>
        ...
        <div className="mt-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-rose-200">
            ...
            <p className="text-rose-600 font-semibold mt-2">- Quran 30:21</p>
          </div>
        </div>
      </div>
    </div>
